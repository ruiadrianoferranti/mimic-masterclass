        ...
        <div className="bg-primary/95 text-white">
          <div className="container py-3 flex flex-wrap items-center justify-between gap-3 text-sm">
            <div className="flex items-center gap-3">
              ...
              <span className="font-mono text-white/90">verify.veritapeplabs.com/{code}</span>
            </div>
          ...
          <div className="container max-w-6xl grid lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="rounded-2xl bg-card border border-border p-6 md:p-8 shadow-elegant">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-xs font-mono uppercase tracking-wider text-primary">VeritaVerify™ Digital COA</div>
                    <div className="text-xs text-muted-foreground">veritapeplabs.com</div>
                  </div>
                </div>
            ...
            <div>
              <div className="flex items-start gap-4 mb-8">
                ...
                <div>
                  <div className="text-sm text-muted-foreground">VeritaVerify™</div>
                  <h1 className="text-3xl md:text-4xl font-bold text-accent">Authenticity Confirmed</h1>
                  <p className="text-muted-foreground mt-2">This result was generated by VeritaPep Labs and has not been altered.</p>
                </div>
              </div>
          ...
          <div className="container max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="rounded-2xl bg-card border border-border p-6 shadow-soft">
                <h3 className="font-bold mb-4 flex items-center gap-2"><FileCheck className="h-5 w-5 text-primary" /> VeritaVerify™ Digital Verification</h3>
                <dl className="space-y-3 text-sm">
                  ...
                  <div><dt className="text-muted-foreground text-xs uppercase">Verification URL</dt><dd className="font-mono text-primary break-all">verify.veritapeplabs.com/{code}</dd></div>
                  <div><dt className="text-muted-foreground text-xs uppercase">Verified</dt><dd>Mar 6, 2026 · 21:48:58 UTC</dd></div>
                  <div><dt className="text-muted-foreground text-xs uppercase">Data Source</dt><dd>VeritaPep LIMS</dd></div>
                </dl>
                <div className="mt-4 pt-4 border-t border-border text-xs text-muted-foreground">
                  <strong className="text-foreground">Laboratory:</strong> VeritaPep Labs · <strong className="text-foreground">Lab ID:</strong> VPL-001
                </div>
