...
const cases = [
  ...
  { icon: AlertTriangle, title: "Test Before the FDA Does", body: "Endotoxin contamination isn't hypothetical — it's in FDA warning letters every quarter. Biosafety testing is liability insurance." },
];
    ...
    <div className="container">
      <div className="grid lg:grid-cols-[1fr_2fr] gap-12 items-start">
        ...
        <div className="space-y-4">
          {cases.map((c) => (
            <div key={c.title} className="flex gap-5 p-6 rounded-xl bg-card border border-border hover:border-primary/30 transition-colors shadow-soft">
